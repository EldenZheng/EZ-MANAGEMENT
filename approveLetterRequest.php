...
// Program Name: approveLetterRequest.php
// Description: approving employee's letter request and send mail
...
// Edited on: Friday, 21-Jul-2023
    ...
    $sqlapprovelet="UPDATE requestletter SET approvalStatus=1 where letterID=$reqID";
    mysqli_query($con,$sqlapprovelet);
    ...
    $subject = "Letter Approval Email - $empName"; // Subject of the email
    $message = "Dear $empName,<br><br>";
    $message .= "We are pleased to inform you that your letter request has been approved. Come pick up the printed letter in the HR office<br><br>";
    ...
    if(send_mail($to,$subject,$message,$empName,$name)){
        echo "Employee's Letter Request Approved!";
